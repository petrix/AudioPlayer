...
let app = (() => {
  ...
  function selectPreset(type) {
    ...
    inputs.forEach(input => input.value = 50 | 0);
    inputs.forEach(input => app.updateSlider(input));
  }
...
function draw() {
  ...
  //   rect((CVS1W / 2) - (lineWidth / 2), (CVS1H / 2), lineWidth, average/2**i, whiteColor);
    }
...
function pushPlay() {
  ...
  eqIn.gain.value = 0;
  eqIn.gain.linearRampToValueAtTime((parseInt($('#preamp1').val())/100), audioCtx.currentTime + 2);
}
...
},{"./equalizer":1,"./sw-bootstrap.js":3,"jquery":4,"lodash":5}],3:[function(require,module,exports){
